        ...
        <div className="flex items-center justify-between h-16">
          ...
          <button onClick={() => setCurrentPage('home')} className="flex items-center gap-2 group">
            ...
            <span className="text-lg font-black dark:text-white text-gray-900">
              Ghost<span className="text-brand-400">VPN</span>
            </span>
          </button>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                  currentPage === item.id
                    ...
                    : 'dark:text-gray-400 text-gray-500 hover:text-brand-400 hover:bg-brand-500/5'
                }`}
              >
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="p-2.5 rounded-xl dark:bg-gray-800/50 bg-gray-100 dark:text-gray-300 text-gray-600 hover:text-brand-400 transition-all duration-200"
            ...
            <button
              ...
              className="md:hidden p-2.5 rounded-xl dark:bg-gray-800/50 bg-gray-100 dark:text-gray-300 text-gray-600 hover:text-brand-400 transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm dark:text-gray-500 text-gray-400">
              Free V2Ray VPN configs optimized for Sri Lankan ISP packages. Trusted since 2020.
            </p>
          </div>
          <div>
